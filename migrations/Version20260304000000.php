...
final class Version20260304000000 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE tournament_registration (id INT AUTO_INCREMENT NOT NULL, tournament_id INT NOT NULL, team_id INT NOT NULL, player_id INT NOT NULL, team_name VARCHAR(255) NOT NULL, contact_email VARCHAR(255) NOT NULL, status VARCHAR(50) DEFAULT \'pending\' NOT NULL, notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_33D666AB33D666AB (tournament_id), INDEX IDX_33D666ABAD6D7735 (team_id), INDEX IDX_33D666AB99E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
